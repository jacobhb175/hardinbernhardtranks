                        ...
                        if (doc.exists) {
                            ...
                            await docRefB.get().then(async function(doc) {
                                if (doc.exists) {
                                    ...
                                    //update rank
                                    db.collection("teams").doc(A).update({mElo:rankA})
                                    db.collection("teams").doc(B).update({mElo:rankB})
                                } else {
                                    // doc.data() will be undefined in this case
                                    console.log("No such document!"+B);
                                }
...
function printRanks(div){
    ...
    db.collection("teams").where("division", "==", div).orderBy("mElo","desc").limit(10)
        .get()
