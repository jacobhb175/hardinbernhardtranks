...
url = "https://hsquizbowl.org/db/tournaments/7094/stats/all_games/games/"
headers={'User-Agent':user_agent,}

def get_HSQBtournaments2(url):
    #html = urlopen(url)
    #bs = BeautifulSoup(html, 'html.parser')
    csvFile = open('ACFCAGA-Data.csv', 'wt+')
    htmlFile = open('ACFCAGA-Stats.html', 'w')
...
#get_tournaments("https://www.naqt.com/stats/tournament/standings.jsp?tournament_id=12587")
'''
...
get_HSQBtournaments2('https://hsquizbowl.org/db/tournaments/7094/stats/all_games/games/')
'''
...
csvFile = open('ACFCAGA-Data.csv', 'wt+')
with open('ACFCAGA-Stats.html') as f:
    # read File
    content = f.read()
    # parse HTML
